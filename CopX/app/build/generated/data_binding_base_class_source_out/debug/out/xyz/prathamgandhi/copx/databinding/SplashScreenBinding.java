...
public final class SplashScreenBinding implements ViewBinding {
  ...
  private SplashScreenBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView3,
  ...
  public static SplashScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SplashScreenBinding((ConstraintLayout) rootView, imageView3, textView2, textView3);
    }
