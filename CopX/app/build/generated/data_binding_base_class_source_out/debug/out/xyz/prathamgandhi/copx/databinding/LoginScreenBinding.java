...
public final class LoginScreenBinding implements ViewBinding {
  ...
  private LoginScreenBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView3,
  ...
  public static LoginScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LoginScreenBinding((ConstraintLayout) rootView, imageView3, loginButton,
          registerButton);
    }
